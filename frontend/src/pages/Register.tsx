    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100 p-4">
      <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-xl w-full max-w-md transition-all duration-300 hover:shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:ring-4 focus:ring-green-300 transition-all duration-200 transform hover:-translate-y-0.5 shadow-lg hover:shadow-green-500/30 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none mt-2"
            type="submit"
            disabled={isLoading}
          >
            {isLoading ? (
